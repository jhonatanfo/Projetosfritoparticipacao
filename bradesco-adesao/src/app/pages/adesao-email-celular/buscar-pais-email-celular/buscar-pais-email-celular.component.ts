...
@Component({
  selector: 'app-buscar-pais-email-celular',
  templateUrl: './buscar-pais-email-celular.component.html',
  styleUrls: ['./buscar-pais-email-celular.component.scss']
})
export class BuscarPaisEmailCelularComponent implements OnInit {
