...
@Component({
  selector: 'app-majorado-s-seguro-sucesso',
  templateUrl: './majorado-s-seguro-sucesso.component.html',
  styleUrls: ['./majorado-s-seguro-sucesso.component.scss']
})

export class MajoradoSSeguroSucessoComponent implements OnInit {
