<?php
/**
 * Classe de detecção de device
 * Adaptado por Jasiel Macedo <jasielmacedo@gmail.com>
 * 
 */
...
class DeviceDetect
{
	...
	*/
	...
	public function mobile_device_detect($iphone=true,$ipad=true,$android=true,$opera=true,$blackberry=true,$palm=true,$windows=true,$mobileredirect=false,$desktopredirect=false){
