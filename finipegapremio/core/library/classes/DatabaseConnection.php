...
class DatabaseConnection{
     ...
     * @return array
     */
    private static function load(string $file=null)
    {
        $port = defined( SSX_DB_PORT) ? SSX_DB_PORT: null;
    	$dadosConfigDb = Array(
    							"sgdb" => SSX_DB_TYPE,
    							"banco"=> SSX_DB_DATABASE,
    							"servidor"=> SSX_DB_HOST,
    							"porta"=> $port,
    							"usuario"=>SSX_DB_USER,
    							"senha"=>SSX_DB_PASS
    					);
        return $dadosConfigDb;
    }
     ...
     * @return PDO
     */
    private static function make(array $dados)
    {
        // capturar dados
     ...
     *
     */
    public static function getInstance(string $file=null)
    {
